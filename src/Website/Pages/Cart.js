    ...
    <>
      <div className="container-fluid" style={{ backgroundColor: "#eee" }} >
        <div className=" shop text-white pt-5">
          ...
          <h1 className='mt-5' style={{ paddingTop: "60px", }}>YOUR CART</h1>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div class="d-grid gap-2 col-6 mx-auto my-auto">
                <button class="btn btn-success text-center " type="button"> <Link to='/checkout' style={{ textDecoration: "none", color: "white" }}>PROCEED TO CHECKOUT<span className="ms-5 ps-5">| &#8377; {subtotal.toFixed(2)} </span> </Link> </button>
