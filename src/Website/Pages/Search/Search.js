...
const Search = () => {
  ...
  const filteredRecords = features.filter(record =>
  ...
  const records = features.slice(firstIndex, lastIndex);
  const npage = Math.ceil(features.length / recordsPerPage);
    ...
    <>
      <div className="container-fluid">
        <div className=" shop text-white pt-5">
          ...
          <h1 className='mt-5' style={{ paddingTop: "60px" }}>PRODUCT SEARCH</h1>
          <h5 className='text-center mt-3'><a href="" style={{ textDecoration: "none", color: "white" }}><i class="fa-solid fa-house"></i> Home</a>/ Search Product</h5>
        </div>
                      ...
                      <div className="card text-center card-bord mx-1 my-2" key={pro1.product_id}>
                        <div className="feat">
                          ...
                          <div className="d-flex">
                            ...
                            <i className="fa-solid fa-heart heart heart-img" style={{ marginLeft: "130px", fontSize: "20px" }}></i>
                          </div>
                        </div>
